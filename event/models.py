...
class Problem(models.Model):
    ...
    penalty             = models.PositiveSmallIntegerField(default=20, help_text='Points Deduction on Incorrect Attempt.')
    point_loss          = models.PositiveSmallIntegerField(default=2, help_text='Point loss per minute.')
    ...
    def clean(self, *args, **kwargs):
        ...
        if minutes * self.point_loss > self.points * 70 / 100:
            raise ValidationError('Point Loss per minute is too high, points should not get less than 30% of the initial value.\nRefer https://codeforces.com/blog/entry/456')

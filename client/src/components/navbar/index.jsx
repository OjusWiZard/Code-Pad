  ...
  return (
    <div>
      ...
      >
          ...
          <Link to="/login">
            <g mask="url(#mask3)">
              <rect
                ...
                height="39.2354"
                fill={`${
                  location.pathname === "/login" ? "#35A4D3" : "#131C20"
                }`}
              />
              <g opacity="0.015">
                <line
        ...
        {token && user ? (
          <text fill="#35A4D3" x="1695" y="78" fontSize="22px" className="font-vcr">{user.full_name.split(" ")[0]}</text>
        ) : (
          <Link to="/login">
            <path
          ...
          >
            ...
            <Link to="/profile">
              <rect
                ...
                height="51.6312"
                fill={`${
                  location.pathname === "/profile" ? "#35A4D3" : "#131C20"
                }`}
              />
            </Link>
            <path
            ...
            <Link to="/profile">
              <path
                ...
                fill={`${
                  location.pathname === "/profile" ? "#131C20" : "#35A4D3"
                }`}
              />
            </Link>
            <path
